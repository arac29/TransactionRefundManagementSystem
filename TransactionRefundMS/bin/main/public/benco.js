    ...
    xhr.onreadystatechange = function () {
        ...
        if (this.readyState == 4 && this.status == 200){
            ...
            reimbursementList.forEach(element => {
                ...
                let changeAmount=document.createElement("td");
                ...
                tableRow.appendChild(changeAmount);
                ...
                let change_cost = document.createElement("form");
                change_cost.action = "change-amount.html";
                let field1 = document.createElement("input");
                let field2 = document.createElement("input");

                field1.type = "hidden";
                field1.name = "eventId";
                field1.value = element.eventId;

                field2.type = "submit";
                field2.className="btn btn-info";
                field2.value = "Confirm amount";

                change_cost.appendChild(field1);
                change_cost.appendChild(field2);
                changeAmount.appendChild(change_cost);
